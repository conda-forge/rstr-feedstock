...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rstr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8703&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rstr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rstr` can be installed with:

```
conda install rstr
```

It is possible to list all of the versions of `rstr` available on your platform with:
